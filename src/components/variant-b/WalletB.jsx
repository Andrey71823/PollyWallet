...
export default function WalletB() {
    ...
    const transactions = [
        { type: 'Daily Interest', date: '2026-01-16 14:30:45', amount: '+$11.23', color: 'text-green-600', iconBg: 'bg-yellow-50', iconColor: 'text-yellow-600', Icon: Sparkles },
        { type: 'Direct Bonus', date: '2026-01-16 10:15:22', amount: '+$150.00', color: 'text-green-600', iconBg: 'bg-pink-50', iconColor: 'text-pink-600', Icon: Gift },
        { type: 'Team Bonus', date: '2026-01-15 18:42:11', amount: '+$85.50', color: 'text-green-600', iconBg: 'bg-pink-50', iconColor: 'text-pink-600', Icon: Gift },
        { type: 'NFT Mint', date: '2026-01-15 09:20:33', amount: '-$1,000.00', color: 'text-red-500', iconBg: 'bg-orange-50', iconColor: 'text-orange-600', Icon: Box },
        { type: 'Transfer - alice123', date: '2026-01-14 16:55:18', amount: '-$250.00', color: 'text-red-500', iconBg: 'bg-purple-50', iconColor: 'text-purple-600', Icon: Send },
        { type: 'Deposit', date: '2026-01-14 12:30:00', amount: '+$2,000.00', color: 'text-green-600', iconBg: 'bg-blue-50', iconColor: 'text-blue-600', Icon: ArrowDownLeft },
        { type: 'Withdraw', date: '2026-01-13 20:15:42', amount: '-$500.00', color: 'text-red-500', iconBg: 'bg-red-50', iconColor: 'text-red-600', Icon: ArrowUpRight },
        { type: 'Daily Interest', date: '2026-01-13 14:30:45', amount: '+$10.87', color: 'text-green-600', iconBg: 'bg-yellow-50', iconColor: 'text-yellow-600', Icon: Sparkles },
    ];
        ...
        <LayoutB>
            ...
            <div className="px-6 pt-3 pb-4 space-y-4">
                ...
                <div className="flex justify-between items-start mb-0">
                    <div>
                        <p className="text-gray-400 font-bold text-sm">Good Afternoon,</p>
                ...
                <div className="text-center space-y-4 py-0">
                    <div>
                        <p className="text-gray-400 font-bold text-[10px] tracking-widest uppercase mb-1">Total Balance</p>
                    ...
                    <div className="flex gap-4 px-1">
                        <div className="flex-1 bg-white p-4 rounded-[24px] shadow-[0_10px_30px_-5px_rgba(0,0,0,0.05)] text-left border border-gray-50">
                            <p className="text-[9px] text-gray-400 font-bold uppercase tracking-wider">Total Invest</p>
                            <p className="text-xl font-black text-green-600">$1,248.50</p>
                            <div className="mt-1 flex items-center justify-between">
                                <p className="text-[10px] text-green-500 font-bold">+ $11.23</p>
                                <span className="bg-green-50 text-green-600 text-[8px] font-black px-1.5 py-0.5 rounded border border-green-100">APY 10%</span>
                            </div>
                        </div>
                        <div className="flex-1 bg-white p-4 rounded-[24px] shadow-[0_10px_30px_-5px_rgba(0,0,0,0.05)] text-left border border-gray-50">
                            <p className="text-[9px] text-gray-400 font-bold uppercase tracking-wider mb-1">Total Bonus</p>
                ...
                <div className="flex items-center gap-3 px-1">
                    <button onClick={() => setActiveModal('deposit')} className="flex-1 h-14 bg-black rounded-[20px] flex items-center justify-center gap-2 shadow-[0_10px_20px_rgba(0,0,0,0.15)] hover:scale-[1.02] active:scale-[0.98] transition-all relative overflow-hidden group">
                        ...
                        <span className="text-white font-bold text-[15px] relative z-10">Deposit</span>
                    </button>
                    <button onClick={() => setActiveModal('withdraw')} className="flex-1 h-14 bg-white rounded-[20px] flex items-center justify-center gap-2 shadow-[0_10px_20px_rgba(0,0,0,0.04)] border border-gray-50 hover:bg-gray-50 hover:scale-[1.02] active:scale-[0.98] transition-all">
                        ...
                        <span className="text-gray-900 font-bold text-[15px]">Withdraw</span>
                    </button>
                    <button onClick={() => setActiveModal('send')} className="flex-1 h-14 bg-white rounded-[20px] flex items-center justify-center gap-2 shadow-[0_10px_20px_rgba(0,0,0,0.04)] border border-gray-50 hover:bg-gray-50 hover:scale-[1.02] active:scale-[0.98] transition-all">
                        ...
                        <span className="text-gray-900 font-bold text-[15px]">Send</span>
                    </button>
                </div>
                ...
                <div className="relative overflow-hidden bg-[#1A1D1F] p-6 rounded-[32px] shadow-[0_20px_40px_-10px_rgba(0,0,0,0.3)] text-white flex justify-between items-center group cursor-pointer hover:scale-[1.02] transition-transform duration-500">
                    ...
                    <div className="relative z-10">
                        <div className="flex items-center gap-2 mb-2">
                            <h3 className="font-black text-xl tracking-tight">UPGRADE PRO</h3>
                ...
                <div className="px-1 pb-12">
                    <div className="flex justify-between items-center mb-4 px-1">
                        <h3 className="text-lg font-black text-gray-900">Transactions</h3>
                        <button
                            type="button"
                    ...
                    <div className="fixed inset-0 z-[100] flex items-end sm:items-center justify-center">
                        ...
                        <div className="bg-white w-full sm:w-[420px] rounded-t-[32px] sm:rounded-[32px] p-6 pb-10 sm:pb-8 shadow-2xl relative z-10 animate-slide-up">
                            ...
                            <div className="flex justify-between items-center mb-6">
                                <h2 className="text-2xl font-black text-gray-900">Deposit USDC</h2>
                            ...
                            <div className="space-y-4">
                                <div>
                                    ...
                                    />
                                    <p className="text-right text-xs text-gray-400 font-medium mt-2">Balance: 8,234.56 USDC (Polygon)</p>
                                </div>
                ...
                {activeModal === 'send' && (
                    <div className="fixed inset-0 z-[100] flex items-end sm:items-center justify-center">
                        ...
                        <div className="bg-white w-full sm:w-[420px] rounded-t-[32px] sm:rounded-[32px] p-6 pb-10 sm:pb-8 shadow-2xl relative z-10 animate-slide-up">
                            ...
                            <div className="flex justify-between items-center mb-6">
                                <h2 className="text-2xl font-black text-gray-900">Send</h2>
                                <button onClick={closeModal} className="w-10 h-10 bg-gray-100 rounded-full flex items-center justify-center text-gray-500 hover:bg-gray-200 transition-colors">
                                    <X size={20} />
                                </button>
                            </div>
                            ...
                            <div className="space-y-4">
                                <div>
                                    <span className="text-sm font-bold text-gray-500 block mb-2">Recipient ID</span>
                                    <input
                                        type="text"
