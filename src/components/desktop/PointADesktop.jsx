        ...
        <LayoutADesktop>
            <div className="space-y-6">
                ...
                <div className="flex items-center justify-between">
                    <h1 className="text-2xl font-black text-gray-900 tracking-tight">{t('pointsAirdrops', 'Points & Airdrops')}</h1>
                        ...
                        <div className="flex gap-3">
                            <div className="flex-1 bg-white/10 backdrop-blur-md rounded-2xl p-4 border border-white/5 hover:bg-white/15 transition-colors">
                                <div className="flex items-center gap-2 text-green-400 mb-1">
                                    <TrendingUp size={16} />
                                    <span className="text-sm font-bold">+{formatNumber(1234)} {t('pointsTitle', 'Points')}</span>
                                </div>
                                <p className="text-xs text-white/60 font-medium">{t('sinceLastCycle', 'since last cycle')}</p>
                            </div>
                            ...
                            <div className="flex-1 bg-gradient-to-br from-blue-600/80 to-blue-500/80 backdrop-blur-md rounded-2xl p-4 border border-white/10 shadow-lg shadow-blue-900/20">
                                <div className="flex items-center gap-2 text-white mb-1">
                                    ...
                                    <span className="text-sm font-bold uppercase">50% APY</span>
                                </div>
                                <p className="text-xs text-white/80 font-medium">{t('onHeldPoints', 'on held points')}</p>
                            </div>
                        </div>
                    </div>
                </div>
